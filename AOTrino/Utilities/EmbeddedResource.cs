...
// loads and caches embedded text resources (JS/CSS/HTML) by their logical name. AOTrino uses it for its own
// __aotrino runtimes; apps can use it (via WebViewWindow.AddStartupScriptResource, or directly) to keep
// scripts in .js files instead of C# string literals. drop files under a project's Scripts\ folder and they
// are embedded with their bare file name as the logical name (see Directory.Build.targets).
