...
// the .NET half of the Fluent starter. small on purpose: this sample is about the front-end layer,
// and the bridge itself is covered by AOTrino.Samples.HostObjects and docs/BRIDGE.md.
...
#pragma warning disable CA1822 // Mark members as static.
    ...
    // the page passes "USERNAME" or "COMPUTERNAME", nothing about the user or the machine is compiled into the bundle,
    // and adding a variable needs no .NET change at all.
    // a real app should think about what it exposes here: this hands the page every variable in the process environment,
    // which is fine for local content you wrote and a poor idea for anything you didn't.
