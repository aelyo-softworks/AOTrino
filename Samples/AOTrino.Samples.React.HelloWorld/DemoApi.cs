...
#pragma warning disable CA1822 // Mark members as static
    ...
    // the AOTrino SDK's informational version (it carries the build timestamp, so it changes every rebuild)
    // and the version of the WebView2 runtime actually rendering this page
