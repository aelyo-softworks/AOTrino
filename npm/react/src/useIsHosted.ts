...
// AOTrino injects its runtime before any page script runs, so this can't change for the life of the
// document: it's read once and kept, which also keeps it stable across renders.
