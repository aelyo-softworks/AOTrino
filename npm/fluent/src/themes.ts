...
// `label` is user-visible, so it belongs to the app, not to this package: replace the built-ins 
// (or pass your own list) to ship another language or another design.
