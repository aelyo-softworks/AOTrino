export type { AOTrinoRuntime, AOTrinoSystem, AOTrinoWindowInfo, BufferCallback, BufferMetadata, WebView, WebViewMessageEvent } from "./runtime.js";
export { isHosted, system, windowInfo } from "./runtime.js";
